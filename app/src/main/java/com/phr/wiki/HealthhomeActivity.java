...
public class HealthhomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton more_btn=findViewById(R.id.ib_moreIcon);
        more_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent();
                it.setClass(HealthhomeActivity.this,HealthTipActivity.class);
                startActivity(it);
            }
        });
        ImageButton jiankansudi_btn=findViewById(R.id.ib_jiankansudiIcon);
        jiankansudi_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent();
                it.setClass(HealthhomeActivity.this,HealthNewsActivity.class);
                startActivity(it);
            }
        });
        ImageButton yaopinchaxun_btn=findViewById(R.id.ib_yaopinchaxunIcon);
        yaopinchaxun_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent();
                it.setClass(HealthhomeActivity.this,DrugInquiryActivity.class);
                startActivity(it);
            }
        });
        ...
        TipAdapter tipAdapter=new TipAdapter(HealthhomeActivity.this,
                R.layout.health_tip_item, tipList);
        HealthStationInfoAdapter adapter=new HealthStationInfoAdapter(HealthhomeActivity.this,
                R.layout.healthstationinfo_item, healthStationInfoList);
        ListView listView = findViewById(R.id.lv_healthstation);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(HealthhomeActivity.this, HealthstationActivity.class);
        ...
        tip_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(HealthhomeActivity.this, HealthTipInfoActivity.class);
                i.putExtra("tipTitleArray", TipTitles[position].toString());
                i.putExtra("tipContentArray", TipContent[position].toString());
                startActivity(i);
               // Toast.makeText(HealthhomeActivity.this,tip.getTipTitle(),
